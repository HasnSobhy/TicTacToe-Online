...
def clicked1():
    ...
    if (player == 1):
        ...
        if(btn1['text'] == " "):
            ...
            btn_number = "1"
            s.send(btn_number.encode("utf-8")) 
            check()
...
btn1=Button(wind,text=" ",bg="blue",fg="#ffffff",width=4,height=4,font='Times',command=clicked1)
btn1.grid(row=0,column=1)

btn2=Button(wind,text=" ",bg="blue",fg="#ffffff",width=4,height=4,font='Times',command=clicked2)
btn2.grid(row=0,column=2)

btn3=Button(wind,text=" ",bg="blue",fg="#ffffff",width=4,height=4,font='Times',command=clicked3)
btn3.grid(row=0,column=3)

btn4=Button(wind,text=" ",bg="blue",fg="#ffffff",width=4,height=4,font='Times',command=clicked4)
btn4.grid(row=1,column=1)

btn5=Button(wind,text=" ",bg="blue",fg="#ffffff",width=4,height=4,font='Times',command=clicked5)
btn5.grid(row=1,column=2)

btn6=Button(wind,text=" ",bg="blue",fg="#ffffff",width=4,height=4,font='Times',command=clicked6)
btn6.grid(row=1,column=3)

btn7=Button(wind,text=" ",bg="blue",fg="#ffffff",width=4,height=4,font='Times',command=clicked7)
btn7.grid(row=2,column=1)

btn8=Button(wind,text=" ",bg="blue",fg="#ffffff",width=4,height=4,font='Times',command=clicked8)
btn8.grid(row=2,column=2)

btn9=Button(wind,text=" ",bg="blue",fg="#ffffff",width=4,height=4,font='Times',command=clicked9)
btn9.grid(row=2,column=3)

s.connect((host, port))
start_new_thread(rec ,(s,))
